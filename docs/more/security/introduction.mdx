...
Read our [GDPR compliance guide](/docs/todo) for more information.
...
Read our [CCPA compliance guide](/docs/todo) for more information.

## HIPAA

By [self-hosting Lunary](/docs/todo) on your own infrastructure, you maintain full control of your data, making it an ideal solution for LLM observability in healthcare settings.
